...
for (const track of tracks) {
    ...
    // the line above appends the template object to the main
    i += 1;
}
// const template = `
...
// const playSong = (ev) => {
//   document.querySelector('currentTarget').dataset.index
//     console.log(ev.currentTarget.dataset.index);  // only gets called when clicking a particular element
//     const idx = Number(ev.currentTarget.dataset.index);
//     const currentTrack = tracks[idx];
//     console.log(currentTrack);
